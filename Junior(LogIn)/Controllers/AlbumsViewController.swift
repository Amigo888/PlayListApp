...
class AlbumsViewController: UIViewController {
    ...
    private func setNavigationBar() {
        ...
        //add searchController on navBar
        navigationItem.searchController = searchController
        
        let userInfo = createCustomButton(selector: #selector(userInfoButtonTapped))
        navigationItem.rightBarButtonItem = userInfo
        ...
        NetworkDataFetch.shared.fetchAlbum(urlString: urlString) { [weak self] albumModel, error in
            ...
            if error == nil {
                ...
                if albumModel.results != [] {
                    let sortedAlbums = albumModel.results.sorted { firstItem, seconItem in
                        return firstItem.collectionName.compare(seconItem.collectionName) == ComparisonResult.orderedAscending
                    }
